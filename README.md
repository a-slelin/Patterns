...
Здесь моей целью было изучить паттерны проектирования от "Банды Четырёх", а также привести примеры их использования.

## Содержание

* **\*.md** - описание проекта или паттерна.
* **behavioral** - все поведенческие паттерны. 
* **generating** - все порождающие паттерны.
* **structural** - все структурные паттерны.
* **\*.png** - картинки, которые используются в конспектах. 
